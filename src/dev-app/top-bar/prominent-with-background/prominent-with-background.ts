...
@Component({
    moduleId: module.id,
    selector: 'prominent-with-background',
    templateUrl: 'prominent-with-background.html',
    styleUrls: ['prominent-with-background.css']
})
export class ProminentTopBarWithBackgroundImageDemo {
